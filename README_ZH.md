...
时间轮定时器使用
------------------------
在游戏业务中，延时任务的需求量是巨大的，尤其是放置类的卡牌slg，我理想中延时任务就是很纯粹的，多久之后，要做什么，再多的花式技巧，其本质还是不变的。到点做事。 
所以，savior的timer没有过多的其他功能，但是我认为对于使用者来说还是很好魔改的。
采用时间轮就不用多说了，相比于全遍历和最小堆顶来说是性价比最高的定时器实现方式。   
